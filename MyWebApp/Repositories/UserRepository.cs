...
namespace MyWebApp.Repositories
{
    public class UserRepository : IUserService
    {
        ...
        private readonly List<string> _listSortOrderDatabase = new List<string>() { "user_name", "user_fullname", "user_email" };
        ...
        public Tuple<int, List<UserModel>> GetAllUsersWithRawFilters(StateModel stateModel)
        {
            try
            {
                ...
                return _pagination.GetByRawOrderPagiList<UserModel>(pagiList, stateModel, _perPage, _listQueries.ToArray());
            }
            catch(Exception e)
            {
